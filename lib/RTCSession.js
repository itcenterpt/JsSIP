...
module.exports = class RTCSession extends EventEmitter
{
  ...
  constructor(ua)
  {
    ...
    this._iceGatheringTimeout = JsSIP_C.ICE_GATHERING_TIMEOUT;
  }
  ...
  connect(target, options = {}, initCallback)
  {
    ...
    this._iceGatheringTimeout = options.iceGatheringTimeout || this._iceGatheringTimeout;
    ...
    return Promise.resolve()
      ...
      .then(() =>
      {
        ...
        return new Promise((resolve) =>
        {
          ...
          {
            debug(`ice gathering timeout after ${this._iceGatheringTimeout} milliseconds`);
            ready();
